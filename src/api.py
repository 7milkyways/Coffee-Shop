...
def after_request(response):
    response.headers.add('Access_Control_Allowed_Headers', 'Content-Type,Authorization')
    response.headers.add('Access_Control_Allowed_Methods', 'POST, PATCH, GET, DELETE')
    return response
